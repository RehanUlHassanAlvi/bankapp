...
const saveClientProofOfResidence = async (req, res) => {
  try {

    // Destructure the request body
    const { 
      userId,id, residentialDetails, durationOfStay, specificDetails, physicalAddress, 
      townCity, attachmentFrontPage, attachmentBackPage, plotNumber, 
      leaseAgreementDate, leaseAgreementDuration, titleDeedNumber, 
      attachmentAllPages, companyName, designation, affidavitDesignation 
    } = req.body;
...
module.exports = {
  ...
  deleteProofOfResidence,saveClientProofOfResidence
};
